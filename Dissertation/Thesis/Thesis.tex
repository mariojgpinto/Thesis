...
\usepackage[english,portuges]{babel} %\usepackage[english,portuges]{babel} % amazingly, the filename is really "portuges"! 
...
\usepackage[pdfauthor={Mario Pinto, PG17664},%
            pdftitle={360 Fast 3D Data Acquisition using a Static Setup},%
...
\def\chapterautorefname{Capítulo}       % Make hyperref's autoref names start with capital letters.
\def\sectionautorefname{Secção}       % See url below for default values:
\def\subsectionautorefname{Subsecção} % http://www.tug.org/applications/hyperref/manual.html#TBL-23
\def\tableautorefname{Tabela}           % Note: autoref feature didn't seem to work with tables
...
\input{./[01]Introduction/[01][00]Introduction}
\input{./[01]Introduction/[01][01]Motivação}
\input{./[01]Introduction/[01][02]Objetivos}
\input{./[01]Introduction/[01][03]Estrutura_do_Documento}

\input{./[02]SoA/[02][00]Introdução}
\input{./[02]SoA/[02][01]Metodos_de_Captura}
\input{./[02]SoA/[02][02]Sistemas_de_Aquisição_360}
\input{./[02]SoA/[02][03]Aplicações}
\input{./[02]SoA/[02][04]Sumário}


\input{./[03]Desenho/[03][00]Introdução}
\input{./[04]Implementação/[04][00]Introdução}
\input{./[05]Resultados/[05][00]Introdução}
\input{./[06]Conclusão/[06][00]Introdução}
